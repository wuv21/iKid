...
class GoodViewController: UIViewController {
    ...
    private var questionController : GoodQuestionViewController!
    private var answerController : GoodAnswerViewController!
    
    
    private func firstBuilder() {
        if questionController == nil {
            questionController = storyboard?.instantiateViewControllerWithIdentifier("GoodQuestion") as! GoodQuestionViewController
        }
    }
    
    private func secondBuilder() {
        if answerController == nil {
            answerController = storyboard?.instantiateViewControllerWithIdentifier("GoodAnswer") as! GoodAnswerViewController
        }
    }
